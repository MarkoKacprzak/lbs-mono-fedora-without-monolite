...
#https://github.com/mono/mono/commit/76d4e2ad1e7b8e19983a282e652e4266cf3fe0f6
...
#https://github.com/mono/mono/commit/c4667496bf3a82b91173c07a761d1dcbf935edf9
Patch1:         mono-fix-Microsoft.Portable.Common.targets.patch
#https://github.com/mono/mono/pull/997
Patch2:         mono-libgdiplusconfig.patch
...
Group:          Development/Languages
Requires:       mono-core = %{version}-%{release}
Requires:       mono-rx = %{version}-%{release}
...
Group:          Development/Languages
Requires:       mono-core = %{version}-%{release}
Requires:       mono-rx = %{version}-%{release} pkgconfig

%description rx-devel
...
Group:          Development/Languages
Requires:       mono-core = %{version}-%{release}
Provides:       mono(System.Data.Entity)
...
%{monodir}/3.5/xbuild.rsp
%{monodir}/?.5/MSBuild/Microsoft.Build*
...
%changelog
* Fri Apr 17 2014 Timotheus Pokorra <timotheus.pokorra@solidcharity.com> - 3.4.0-3
- make sure all binaries are removed
